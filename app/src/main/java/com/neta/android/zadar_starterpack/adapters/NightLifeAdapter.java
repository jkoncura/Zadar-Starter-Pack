...
import com.neta.android.zadar_starterpack.NightLifeItemActivity;
...
public class NightLifeAdapter extends RecyclerView.Adapter<ItemViewHolder>{

    private static final String TAG = "NightLifeAdapter";
    ...
    public NightLifeAdapter(Context mContext, List<Item> mItems){
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder holder, final int position) {
        ...
        holder.enableClick(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, NightLifeItemActivity.class);
